...
```bash
curl -LO [https://github.com/Warl0rdd/k-ray/releases/download/latest/k-ray-linux-amd64](https://github.com/Warl0rdd/k-ray/releases/latest/download/k-ray-linux-amd64)
